...
* 如果你声明为 `internal`，它会在相同[模块](https://book.kotlincn.net/text/visibility-modifiers.html#%E6%A8%A1%E5%9D%97)内随处可见。
* `protected` 修饰符不适用于顶层声明。

> 要使用另一包中可见的顶层声明，需要将其[导入](https://book.kotlincn.net/text/packages.html#%E5%AF%BC%E5%85%A5)进来。
