...
* 数据在初始化时不一致，例如当：
  ...
  * [超类的构造函数调用一个开放成员](https://book.kotlincn.net/text/inheritance.html#%E6%B4%BE%E7%94%9F%E7%B1%BB%E5%88%9D%E5%A7%8B%E5%8C%96%E9%A1%BA%E5%BA%8F)，该成员在派生中类的实现使用了未初始化的状态。
* Java 互操作：
  * 企图访问[平台类型](https://book.kotlincn.net/text/java-interop.html#%E7%A9%BA%E5%AE%89%E5%85%A8%E4%B8%8E%E5%B9%B3%E5%8F%B0%E7%B1%BB%E5%9E%8B)的 `null` 引用的成员；
...
可以为[可空接收者](https://book.kotlincn.net/text/extensions.html#%E5%8F%AF%E7%A9%BA%E6%8E%A5%E6%94%B6%E8%80%85)定义扩展函数。 这样就可以为空值指定行为，而无需在每个调用处都使用空检测逻辑。
...
如果希望调用 `toString()` 返回一个可空字符串，请使用[安全调用操作符 `?.`](https://book.kotlincn.net/text/null-safety.html#%E5%AE%89%E5%85%A8%E7%9A%84%E8%B0%83%E7%94%A8)：
